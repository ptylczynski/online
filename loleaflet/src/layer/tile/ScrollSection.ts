...
class ScrollSection {
	...
	private drawVerticalScrollBar () {
		...
		this.context.fillRect(startX + this.sectionProperties.roundedDpi, scrollProps.startY - this.sectionProperties.roundedDpi, 0, this.sectionProperties.roundedDpi);
        ...
        this.context.fillRect(startX + this.sectionProperties.roundedDpi, scrollProps.startY + scrollProps.scrollSize - this.sectionProperties.scrollBarThickness, 0, this.sectionProperties.roundedDpi);
